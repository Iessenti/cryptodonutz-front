    ...
    return (
        ...
        >
...

            {
                ...
                &&
                <div
                    className='badges-container__new-badge-wrapper'
                >
                    <span>
            ...
            <div
                className='badges-container__table'
            >

                <div
                    className='badges-container__table__header'
                >
                    {
                        tableHeaderTitles.map( (title, titleIndex) => (
                            <div
                                key={'badges_page_table_header_'+title}
                            >
                ...
                <div
                    className='badges-container__table__main'
                >
                    {
                        badgesList
                        &&
                        ...
                        badgesList.map( (row, rowIndex) => (
                            ...
                            >
                                ...
                                >
                                    {
                                        row.owners_quantity ? row.owners_quantity : 0
                                    }
                                    /
                                    {
                                        row.quantity
