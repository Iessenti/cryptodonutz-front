...
const CreatorsListContainer = () => {
    ...
    return (
        <div
            className='creators-list-container'
        >
            <PageTitle
                formatId='page_title_creators'
            />  
            <div
                className='creators-list-container__search'
            >   
                <SearchLoupeIcon/>
                <input
                    type='text'
            ...
            <div
                className='creators-list-container__list'
            >
                {
                    usersList.length===0
                    ?
                    <span
                        className='creators-list-container__list__not-found'
                    >
                    ...
                    usersList.map( (user, userIndex) => (
                        ...
                        >
                            <div
                                className='creators-list-container__list__panel__image'
                            >
                                {
                            ...
                            <div
                                className='creators-list-container__list__panel__info'
                            >
                                <span
                                    className='username'
                                >
