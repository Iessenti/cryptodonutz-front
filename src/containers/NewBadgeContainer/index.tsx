...
const NewBadgeContainer = () => {
    ...
    const [form, setForm] = useState({
        badge_name: '', badge_desc: '', link: '', quantity: ''
    })
    ...
    const createBadge = async () => {
        ...
        if (result) {
            ...
            await axios.post(
                '/api/badge/create-image/'+result.badge.id,
                formData
            ).then( res => {
                if (res) {
    ...
    return (
        ...
        >
            ...
            <PageTitle
                formatId='create_badge_title'
            />

            <div
                className='new-badge-container__form'
            >
                <div
                    className='new-badge-container__form__input-wrapper'
                >
                    <span
                        className='title'
                    >
                ...
                <LargeInput
                    ...
                    onChange={(event) => setForm({...form, badge_desc: event.target.value})}
                    isRedDot={true}
                    isTextarea={true}
                />
                <LargeInput
