...
const PersonMainInfo = () => {
    ...
    const sendFile = (file: any, fileName: any) => {
        ...
        axios.post('/api/user/user/edit-image/'+tron_token, formData)
    ...
    return (
        ...
        >
            ...
            >   
                {
                    data.avatarlink && data.avatarlink.length>0 || imagebase64.length>0
                    ?
                    <img 
                        src={
                            fileName.length>0
                            ...
                            (imagebase64 || '')
                            :
                            (data.avatarlink && data.avatarlink.length>0 && `${url + data.avatarlink}`)
                        }
                    />
                    :
                    <div className='icon' />
            ...
            <div
                className='person-main-info__personal'
            >
                <span
                    className='title'
                >
            ...
            <div
                className='person-main-info__date'
            >
                Joined in 
                {
                    data.creation_date && data.creation_date.length>10
                    ?
                    ( ' ' + months[data.creation_date.slice(6,7)-1] + ' ' + data.creation_date.slice(0,4))
                    :
